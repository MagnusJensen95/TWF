...
using WeddingFolderAPI.Models.AccountViewModels;
...
namespace WeddingFolderAPI.Controllers
{
    ...
    public class AccountsController : Controller
    {
        ...
        public async Task<IActionResult> Post([FromBody]RegistrationViewModel model)
          ...
          //  var newUserId = _appDbContext.Users.SingleOrDefault(user => user.FirstName == model.FirstName);
            await _appDbContext.ActualUsers.AddAsync(new ActualUser { Identity = userIdentity });
